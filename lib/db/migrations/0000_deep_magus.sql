CREATE TYPE "public"."gateway_name" AS ENUM('fluidpay', 'nmi', 'dejavoo_spin');--> statement-breakpoint
CREATE TYPE "public"."merchant_gateway_status" AS ENUM('active', 'disabled');--> statement-breakpoint
...
CREATE TABLE "merchants" (
	...
	"default_email_template" text DEFAULT '' NOT NULL,
...
CREATE TABLE "merchant_gateways" (
	...
	"status" "merchant_gateway_status" DEFAULT 'active' NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "merchant_gateways" ADD CONSTRAINT "merchant_gateways_merchant_id_merchants_id_fk" FOREIGN KEY ("merchant_id") REFERENCES "public"."merchants"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "merchants_slug_unique_idx" ON "merchants" USING btree ("slug");--> statement-breakpoint
CREATE UNIQUE INDEX "merchant_gateways_merchant_gateway_unique_idx" ON "merchant_gateways" USING btree ("merchant_id","gateway");--> statement-breakpoint
CREATE UNIQUE INDEX "merchant_gateways_one_primary_per_merchant_idx" ON "merchant_gateways" USING btree ("merchant_id") WHERE "merchant_gateways"."is_primary" = true;--> statement-breakpoint
...
CREATE INDEX "transactions_merchant_created_at_idx" ON "transactions" USING btree ("merchant_id","created_at" desc);--> statement-breakpoint
CREATE INDEX "transactions_user_id_idx" ON "transactions" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "transactions_source_external_invoice_idx" ON "transactions" USING btree ("source_platform","external_invoice_id");